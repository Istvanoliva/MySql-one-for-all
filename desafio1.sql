...
CREATE TABLE IF NOT EXISTS SpotifyClone.history (
    ...
    reproduction_date VARCHAR(40) NOT NULL,
...
INSERT INTO SpotifyClone.user (user_name, user_age, plan_id, data_signature)
VALUES
...
INSERT INTO SpotifyClone.albums (album_name, realesed_year, artist_id)
VALUES
('Envious', 1990, 1),
('Exuberant', 1993, 1),
